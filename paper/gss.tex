...
In general, most trends are driven by increases in the total variance with the spectral concentration often decreasing over time.

\inlinetodo{describe results}
\begin{itemize}
...
%
Interestingly, this exercise also reveals how both the general volatility of spending polarization and the spike in police-related polarization post George Floyd are driven by disagreement \emph{within} the Republican party.
