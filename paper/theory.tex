...
This captures the notion that polarization is exacerbated when disagreement is along a single axis or, as described by \textcite{drutman-2022-multiparty}, when the public is ``locked in a zero-sum struggle along a single `us-vs-them' dimension''.
