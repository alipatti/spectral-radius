...
On distributions with finite and bounded support---i.e., most survey questions---this closely matches one's intuition about what constitutes a highly-polarized distribution.
...
A first attempt at an interpretable scalar summary measure is to simply take the sum of the variances on each individual issue (i.e., the covariance matrix's trace).
...
I elect to use the spectral norm for the remainder of the paper due to its simple interpretation as the variance of the first principal component, but our qualitative findings hold almost identically for other norm choices.
