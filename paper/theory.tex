...
However, at a fixed scale, we can still get insight into the evolution of polarization over time.
...
Notably, we make no assumptions about the distribution $\mathcal F$ from which the responses are drawn except that it has a finite covariance matrix $\Sigma = \Var(\mathbf x_i)$.
