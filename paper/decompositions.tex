...
\begin{equation}
	...
	\end{aligned}
\end{equation}
where $\mu_g = \E{\mathbf x_{i} \given z_i = g}$ is the mean vector of group $g$, $\Sigma_g = \Var(\mathbf x_i \given z_i = g)$ is the group's covariance matrix, and $\mu = \E{\mathbf x_i}$ is the unconditional mean.
%
