...
\begin{itemize}
	...
	\item
		...
		\autoref{fig:between-group-sign} visualizes how between-group differences can amplify, offset, or leave unchanged overall polarization depending on the axis along which each subgroup is polarized.
\end{itemize}
