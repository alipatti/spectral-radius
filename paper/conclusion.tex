...
First, one could explore a wider variety of topics using other data sets (for example, the \textcite{anes}).
For example, the GSS does not ask any long-running questions about views on immigration---a currently very polarizing issue.
...
Repeating this analysis with a panel data set would allow one to fix political party (or any other covariate) at some initial $t=0$, then see how polarization evolves within those static groups.
